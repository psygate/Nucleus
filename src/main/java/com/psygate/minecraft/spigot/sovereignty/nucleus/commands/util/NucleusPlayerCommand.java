 ...
 */
public abstract class NucleusPlayerCommand extends NucleusCommand {

    public NucleusPlayerCommand(int minargs, int maxargs) {
    ...
    public final void subOnCommand(CommandSender commandSender, Command command, String s, String[] strings) throws Exception {
        if (!(commandSender instanceof Player)) {
            throw new CommandException("This is a player only command.");
        } else {
